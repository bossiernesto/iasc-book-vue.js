...
La respuesta rápida es no. No hay manera que la aplicación funcione correctamente en un interleave. esta idea es conocida como el teorema CAPfootnote:3[<a href="https://learnyousomeerlang.com/distribunomicon">Distribunomicon - Learn you some Erlang for greater good]</a>.</p>
</div>
<div class="imageblock center iasc-image">
<div class="content">
<img src="/img/distribucion/image1.png" alt="image1">
</div>
</div>
<div class="paragraph">
...
<div class="sectionbody">
<div class="paragraph">
<p>La interpretación que veremos ahora es la clásica en la que solo se puede tener dos de los tres conceptos de CAPfootnote:1[<a href="http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.67.6951&amp;rep=rep1&amp;type=pdf">Gilbert and Lynch. Brewer conjecture and the feasibility of consistent, available, partition-tolerant web services. ACM SIGACT News (2002) vol. 33 (2) pp. 59]</a>, es decir se puede tener CA, CP o AP. No hay manera de que se puedan tener los tres. Lo malo es que no es posible tener las tres cosas incluso con un fallo de red. Lo bueno es que es un teorema, después veremos que esto es más abierto en la interpretación gradual.  tener Consistencia y Disponibilidad no es posible a menos que teóricamente no falle nunca la red, y si sucede en un nodo todo debería fallar. Entonces nos quedan las otras dos partes. AP o CP. Cuando hay un netsplit o interleave la disponibilidad o consistencia permanecen, pero no ambas.</p>
</div>
<div class="paragraph">
...
<div class="imageblock center iasc-image">
<div class="content">
<img src="/img/distribucion/image14.png" alt="image14">
</div>
</div>
</div>
</div>
...
<div class="sectionbody">
<div class="paragraph">
<p>El otro concepto, un poco más gradual hace hincapié en que hoy por hoy no se puede solo tener dos de estos conceptos que permiten simplificar estos conceptos ya separados, y no hay que elegir entre uno u otro de los otros conceptos aparte de particiones, hablamos de consistencia y disponibilidad, sino que hay un rango de flexibilidad para manejar y recuperarse de las particionesfootnote:4[<a href="http://www.infoq.com/articles/cap-twelve-years-later-how-the-rules-have-changed">Eric A Brewer. CAP twelve years later: How the &#8220;rules&#8221; have changed. IEEE Computer Magazine, 45(2):23&#8212;&#8203;29, February 2012. doi:10.1109/MC.2012.37.]</a>.</p>
</div>
</div>
</div>
<div class="sect1">
...
<div class="imageblock center iasc-image">
<div class="content">
<img src="/img/distribucion/image11.jpg" alt="image11">
</div>
</div>
<div class="paragraph">
...
<dd>
<p>warning
<em>Advertencia: Esta seccion necesita un mayor desarrollo del tema y de citas.</em></p>
<div class="dlist">
<dl>
<dt class="hdlist1">:</dt>
<dd>
<p>Existen tambien criticas al teorema<sup class="footnote" id="_footnote_2">[<a id="_footnoteref_1" class="footnote" href="#_footnotedef_1" title="View footnote.">1</a>]</sup>, en el que se mencionan entre otras cosas, algunas confusiones y ambiguedades de los terminos, y algunos problemas en su formalización. Estas criticas se centran un poco en la dificil aplicacion que puede llegar a tener a veces sobre los sistemas reales.</p>
</dd>
</dl>
</div>
</dd>
...
<a href="#_footnoteref_1">1</a>. Kleppmann, M. (2015). A Critique of the CAP Theorem. <a href="https://doi.org/10.17863/CAM.13083" class="bare">doi.org/10.17863/CAM.13083</a>
</div>
