...
<p>Como vimos en las clases anteriores, Ruby MRI posee "algunos problemas" en cuanto a como maneja el procesamiento en paralelo en múltiples procesadores. Si bien vimos que la concurrencia es algo que perfectamente puede darse sin necesidad de contextos de ejecución que se ejecuten al mismo tiempofootnote:1[<a href="https://arquitecturas-concurrentes.github.io/iasc-book/concurrencia_paralelismo">IASC UTN FRBA. (2020) .Concurrencia y Paralelismo]</a>, vamos a ver en esta sección, nuevos y existentes mecanismos para tratar de resolver este problema latente en MRI desde sus comienzos.</p>
</div>
<div class="paragraph center iasc-image">
<p><span class="image"><img src="/img/guilds/pisa_tower.jpeg" alt="pisa tower"></span></p>
</div>
<h3 id="_un_poco_de_historia" class="discrete">Un poco de historia&#8230;&#8203;</h3>
<div class="paragraph">
<p>Ruby puede implementar mecanismos concurrentes pero no paralelos debido al GVL a.k.a GIL (Global VM Lock o Giant VM Lock), que es un bloqueo de exclusión mutua, en suma, un mutex. Este bloqueo lo mantiene el subproceso del intérprete y lo usa para evitar compartir código que no es seguro para subprocesos con otros subprocesos. Todos los hilos de intérpretes tienen su propio GIL. Debido a dicho GIL, si un programa Ruby tiene múltiples hilos, no pueden ejecutarse al mismo tiempo, porque GIL solo permitirá que se ejecute un subproceso al mismo tiempo. Antes de Ruby 1.9, solo había un hilo del sistema operativo para todos los hilos de sistema de MRI que podemos crear mediante la librería standard de Rubyfootnote:2[<a href="https://ruby-doc.org/core-3.0.2/Thread.html">Ruby Doc. Retrieved 30 August 2021. Thread standard library]</a>.</p>
</div>
<div class="imageblock center iasc-image">
<div class="content">
<img src="/img/guilds/xruby-gil-jvm.png" alt="xruby gil jvm">
</div>
</div>
<div class="dlist">
<dl>
...
<div class="content">
<img src="/img/guilds/in_rod_we_trust.png" alt="in rod we trust">
</div>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>Este tipo de mecanismos son algo visto no solo en MRI sino también en CPythonfootnote:3[<a href="https://wiki.python.org/moin/GlobalInterpreterLock">Python Moin. Retrieved 30 November 2015. GlobalInterpreterLock]</a>, y ambas máquinas virtuales sufren de los mismos problemas.</p>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>Sin embargo, los sistemas operativos modernos, tienen manejo de memoria virtual, que proveen de un mecanismo llamado _copy on write_footnote:4[<a href="http://citeseerx.ist.psu.edu/viewdoc/download;jsessionid=C97A7B66D788B7E4F6D6BF5FDD8EC451?doi=10.1.1.33.3144&amp;rep=rep1&amp;type=pdf">Javier, Francisco &amp; Guttman, Joshua. (1995). Copy on Write.]</a>, que previene del escenario que describimos antes. La memoria virtual de un proceso, esta separado en bloques de 4k, llamadas paginas. Cuando un proceso padre, crea un proceso hijo; el hijo inicialmente comparte todas las paginas de memoria con el padre. Solo cuando el proceso hijo empieza a modificar una o varias de estas paginas, el kernel se encargara de copiar las paginas de memoria modificadas, y de reasignarlo al nuevo proceso.</p>
</div>
<div class="imageblock center iasc-image">
<div class="content">
<img src="/img/guilds/child-processes.svg" alt="child processes">
</div>
</div>
<div class="paragraph">
<p>El diagrama visto más arriba, muestra un poco como van cambiando, y copiandose las paginas a medida que pasa el tiempo. El mecanismo de como MRI aloca memoria puede verse muy bien explicado enfootnote:6[<a href="https://brandur.org/ruby-memory">Brandur. (2017). The Limits of Copy-on-write: How Ruby Allocates Memory]</a>.</p>
</div>
<h3 id="_la_propuesta_guilds" class="discrete">La propuesta: Guilds</h3>
<div class="paragraph">
...
<div class="paragraph">
<p>En 2016, Koichi habló sobre los problemas de la programación de subprocesos múltiples en su presentación en Ruby Kaigifootnote:7[<a href="http://www.atdot.net/~ko1/activities/2016_rubykaigi.pdf">Sasada, Koichi. (2016). A proposal of new concurrency model for Ruby 3 (RubyKaigi2016)]</a>, así como sobre algunas formas comunes de resolverlos. Junto con eso, también presentó su concepto de <code>Guilds</code> por primera vez. Antes de pasar a Ractors, tomemos un momento para comprender los aspectos básicos de Ractors: <code>Guilds</code>.</p>
</div>
<h4 id="_que_es_un_guild" class="discrete">Que es un Guild?</h4>
<div class="dlist">
<dl>
<dt class="hdlist1">:</dt>
<dd>
<p>warning
Las imágenes a continuación fueron tomadas de la presentación de Koichi Sasada<sup class="footnoteref red" title="Unresolved footnote reference.">[7]</sup></p>
<div class="dlist">
<dl>
<dt class="hdlist1">:</dt>
<dd>
...
<div class="imageblock center iasc-image center iasc-image">
<div class="content">
<img src="/img/guilds/guilds_0.png" alt="guilds 0">
</div>
</div>
<div class="paragraph">
...
<div class="imageblock center iasc-image">
<div class="content">
<img src="/img/guilds/guilds_1.png" alt="guilds 1">
</div>
</div>
<div class="paragraph">
...
<div class="imageblock center iasc-image">
<div class="content">
<img src="/img/guilds/guilds_2.png" alt="guilds 2">
</div>
</div>
<div class="paragraph">
...
<div class="imageblock center iasc-image">
<div class="content">
<img src="/img/guilds/guilds_3.png" alt="guilds 3">
</div>
</div>
<div class="imageblock center iasc-image">
<div class="content">
<img src="/img/guilds/guilds_4.png" alt="guilds 4">
</div>
</div>
<div class="paragraph">
...
<div class="imageblock center iasc-image">
<div class="content">
<img src="/img/guilds/guilds_5.png" alt="guilds 5">
</div>
</div>
<h5 id="_uso_propuesto_de_los_guilds" class="discrete">Uso propuesto de los Guilds</h5>
<div class="paragraph">
<p>Koichi habla en su presentación del uso de este nuevo tipo de abstracción<sup class="footnoteref red" title="Unresolved footnote reference.">[7]</sup>, y que separa en distintos casos de uso</p>
</div>
<div class="ulist">
<ul>
<li>
...
<div class="imageblock center iasc-image">
<div class="content">
<img src="/img/guilds/guilds_6.png" alt="guilds 6">
</div>
</div>
<div class="ulist">
<ul>
...
<div class="imageblock center iasc-image">
<div class="content">
<img src="/img/guilds/guilds_7.png" alt="guilds 7">
</div>
</div>
<div class="ulist">
<ul>
...
<div class="imageblock center iasc-image">
<div class="content">
<img src="/img/guilds/guilds_8.png" alt="guilds 8">
</div>
</div>
<h4 id="_ractors_la_implementación_de_guilds" class="discrete">Ractors, la implementación de Guilds</h4>
<div class="paragraph">
...
<div class="imageblock center iasc-image">
<div class="content">
<img src="/img/guilds/homer-grill.gif" alt="homer grill">
</div>
</div>
<div class="paragraph">
...
<h5 id="_ventajas" class="discrete">Ventajas??</h5>
<div class="paragraph">
<p>Con respecto a las ventajas, las mismas son obvias en cuanto a lo que apuntan a resolver. Permitir la ejecución, en múltiples procesadores/cores, permite de alguna manera una mejor performance, reduciendo el tiempo promedio de ejecución de tareas que lo son, y que no generan ningún tipo de relación directa. Veamos el ejemplo mostrado en el realease de Ruby 3.0.0, donde se ejecuta el algoritmo <code>tak\`footnote:8[<a href="https://www.amazon.com/exec/obidos/ISBN%3D0685479412/ericstreasuretroA/">Vardi, I. The Running Time of TAK. Ch. 9 in Computational Recreations in Mathematica. Redwood City, CA: Addison-Wesley, pp. 179-199, 1991.]</a> footnote:9[<a href="https://archive.org/details/AcornUser052-Nov86/page/n198/mode/1up">Testing the Tak. Acorn User. pp. 197, 199.]</a> secuencialmente y usando \`ractors</code> 4 veces.</p>
</div>
<div class="listingblock">
<div class="content">
...
<h5 id="_problemas_latentes" class="discrete">Problemas latentes</h5>
<div class="paragraph">
...
<div class="paragraph">
<p>Esta estructura, tiene que ser siempre usada de una manera correcta (tanto como el resto), ya que un uso poco cuidadoso, usando módulos/clases entre varios Ractorsfootnote:10[<a href="https://docs.ruby-lang.org/en/3.0.0/doc/ractor_md.html#label-Thread-safety">Ruby Lang. (2021). Ractor documentation. Thread-safety.]</a>, puede introducir race conditions. También otra cosa a tener en cuenta, es que el envio de mensajes entre ractors(send, yield, take, etc), es el mismo que hay entre objetos, por lo que es siempre bloqueante. Si estos se usan incorrectamente pueden resultar en <code>dead-locks</code> o <code>live-locks</code> como se menciono antes.</p>
</div>
<div class="paragraph">
...
<h4 id="_uso_actual_de_ractors" class="discrete">Uso actual de Ractors</h4>
<div class="dlist">
<dl>
<dt class="hdlist1">:</dt>
<dd>
...
<h5 id="_paso_de_mensajes" class="discrete">Paso de mensajes</h5>
<div class="ulist">
<ul>
<li>
...
<h5 id="_ciclo_de_vida" class="discrete">Ciclo de Vida</h5>
<div class="paragraph">
